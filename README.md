...
3. [Features](#features)
4. [생성 결과물 예시 (Output Showcase)](#-생성-결과물-예시-output-showcase)
...
- **Output Resolution:** **512×512** - **Training:** LoRA 기반 파인튜닝  
- **Datasets:** 한국 문화 이미지 + 픽셀 아트 데이터 혼합  
![시스템 아키텍처](./static/images/4.png)
---
...
### 1. 저장소 클론
```bash
git clone [https://github.com/yourusername/korea-pixel.git](https://github.com/yourusername/korea-pixel.git)
cd korea-pixel
````
...
| 월영교 | 이순신 장군 동상 | 부산 타워 |
| :---: | :---: | :---: |
| ![월영교 이미지](./static/images/1.png) | ![이순신 장군 이미지](./static/images/2.png) | ![부산 타워 이미지](./static/images/3.png) |
